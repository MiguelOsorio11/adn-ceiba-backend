...
public class ManejadorError extends ResponseEntityExceptionHandler {
    ...
    public ManejadorError() {
        ...
        CODIGOS_ESTADO.put(ExcepcionCitaInvalida.class.getSimpleName(), HttpStatus.BAD_REQUEST.value());
        CODIGOS_ESTADO.put(ExcepcionCancelacionTrabajoDeGrado.class.getSimpleName(), HttpStatus.BAD_REQUEST.value());
